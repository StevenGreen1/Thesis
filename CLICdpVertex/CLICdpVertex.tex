...
%This has the additional benefit of preventing competition for the charge collection, as is the case for conventional MAPS where n-wells from both the collection diode and p-MOS transistors may collect deposited charge.
