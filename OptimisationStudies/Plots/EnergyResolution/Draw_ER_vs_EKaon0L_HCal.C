...
void Draw_ER_vs_EKaon0L_HCal() 
{
    int detModel(85);
    int recoVar(71);
    std::string rootFile("EnergyResolution_PandoraSettingsDefault_DetectorModel_" + NumberToString(detModel) + "_ReconstructionVariant_" + NumberToString(recoVar) + "_Kaon0L.root");
