...
//=========  (Tue Mar 21 10:38:23 2017) by ROOT version5.34/37
   ...
   Reported->SetParameter(0,12.9);
   Reported->SetParError(0,0);
   Reported->SetParLimits(0,0,0);
   Reported->SetParameter(1,1.2);
   ...
   entry=leg->AddEntry("Reported","#it{a} = 12.9%, #it{b} = 1.2%","l");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
