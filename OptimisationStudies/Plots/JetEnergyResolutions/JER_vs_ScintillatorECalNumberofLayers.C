{
    ...
    float Jet_Energy_91GeV_JER[4] = {4.05896,3.92149,3.71533,3.62486};

    float Jet_Energy_200GeV_JER[4] = {3.22033,3.07651,2.93539,2.91273};

    float Jet_Energy_360GeV_JER[4] = {3.05599,2.96383,2.89854,2.86016};

    float Jet_Energy_500GeV_JER[4] = {3.23834,3.14833,3.16672,3.12067};

    float Jet_Energy_91GeV_JERError[4] = {0.051653,0.0499037,0.0472801,0.0485825};

    float Jet_Energy_200GeV_JERError[4] = {0.0412388,0.0393971,0.03759,0.0372998};

    float Jet_Energy_360GeV_JERError[4] = {0.0390416,0.0378643,0.0370302,0.0365398};

    float Jet_Energy_500GeV_JERError[4] = {0.0413544,0.0402049,0.0404398,0.0398517};
