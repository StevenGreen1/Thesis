{
    ...
    float Pandora_Settings_Default_JER[5] = {3.07079,2.91977,2.90164,2.79668,2.84442};

    float Pandora_Settings_PerfectPFA_JER[5] = {2.14589,2.09841,2.08207,2.09225,2.08264};

    float Pandora_Settings_TotalConfusion_JER[5] = {2.19656716993,2.03020499576,2.02101439992,1.85577718487,1.93735277294};

    float Pandora_Settings_PhotonConfusion_JER[5] = {0.846608561084,0.627879543623,0.6780299208,0.656102084664,0.726488217386};

    float Pandora_Settings_NeutralHadronConfusion_JER[5] = {1.48828505133,1.5156351941,1.44011317253,1.39801667372,1.37158595411};

    float Pandora_Settings_OtherConfusion_JER[5] = {1.37592473715,1.19597222455,1.24533075185,1.02907161772,1.15944064415};

    float Pandora_Settings_Default_JERError[5] = {0.0418269,0.039667,0.0371913,0.0385539,0.0401901};

    float Pandora_Settings_PerfectPFA_JERError[5] = {0.0292289,0.0285083,0.0266867,0.0288429,0.0294265};

    float Pandora_Settings_TotalConfusion_JERError[5] = {0.0510276625812,0.04884866481,0.0457751148841,0.0481489123254,0.0498113569339};

    float Pandora_Settings_PhotonConfusion_JERError[5] = {0.0580170687231,0.0554447478558,0.0518720921265,0.0537684185966,0.0559040456075};

    float Pandora_Settings_NeutralHadronConfusion_JERError[5] = {0.0531233034763,0.0507685569755,0.0476933076897,0.0493737973077,0.0514211590706};

    float Pandora_Settings_OtherConfusion_JERError[5] = {0.0453861924987,0.0434675723239,0.0409770163,0.0431861942259,0.0447240360576};
    ...
    pLegend->Draw("same");
    pCanvasEj->SaveAs("JER_vs_HCalCellDepth_200GeV_DiJet_Breakdown.pdf");
}
