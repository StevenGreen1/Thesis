{
    ...
    float Pandora_Settings_Default_JER[8] = {3.5954,3.33187,3.19261,3.15088,3.06618,2.9751,3.02383,2.91974};

    float Pandora_Settings_PerfectPFA_JER[8] = {1.8712,1.81321,1.73629,1.74092,1.65118,1.67587,1.61833,1.60028};

    float Pandora_Settings_TotalConfusion_JER[8] = {3.07009962705,2.79528660298,2.67918936397,2.62626014096,2.58361459974,2.45818627307,2.55432102133,2.4421272672};

    float Pandora_Settings_PhotonConfusion_JER[8] = {1.41775265653,1.31724178191,1.21652396179,1.28899175668,1.21946063073,1.1309451412,1.27421066013,0.999236459853};

    float Pandora_Settings_NeutralHadronConfusion_JER[8] = {2.03636607743,1.90586310928,1.80670926538,1.79028628102,1.78524493266,1.73959902296,1.77222822822,1.77107671751};

    float Pandora_Settings_OtherConfusion_JER[8] = {1.80795528805,1.56402912041,1.56010471725,1.42499740744,1.41452490275,1.31811914484,1.32670651642,1.35233107899};

    float Pandora_Settings_Default_JERError[8] = {0.0459403,0.0425731,0.0407937,0.0402604,0.0391782,0.0381957,0.038637,0.0373071};

    float Pandora_Settings_PerfectPFA_JERError[8] = {0.0239093,0.0231684,0.0221854,0.0222447,0.021098,0.0215157,0.0206782,0.0204476};

    float Pandora_Settings_TotalConfusion_JERError[8] = {0.0517896287611,0.0484689705634,0.0464362477609,0.045996972852,0.0444978297816,0.0438386795616,0.0438224459922,0.0425432329067};

    float Pandora_Settings_PhotonConfusion_JERError[8] = {0.0623928459675,0.0578072555259,0.0555574578952,0.0545025667604,0.0531701598333,0.0520287138302,0.0521586804962,0.0511919781818};

    float Pandora_Settings_NeutralHadronConfusion_JERError[8] = {0.0537368820092,0.049651979551,0.0480841846058,0.0466475355069,0.0454306532631,0.0446922015115,0.0440761495949,0.0441077998422};
