{
    ...
    TH2F *pAxesEj = new TH2F("axesEj","",1200,1,25,12000,2.5,4.5);
    ...
    float Jet_Energy_200GeV_JER[6] = {3.02508,2.83502,2.8389,2.97549,3.23232,3.5291};

    float Jet_Energy_360GeV_JER[6] = {2.94836,2.95693,2.93841,3.03519,3.50091,3.85991};

    float Jet_Energy_500GeV_JER[6] = {3.15527,3.15274,3.14733,3.41274,3.73829,4.18223};

    float Jet_Energy_91GeV_JERError[6] = {0.0469704,0.0463452,0.0451102,0.0459391,0.0486821,0.0511228};

    float Jet_Energy_200GeV_JERError[6] = {0.0387385,0.0363046,0.0382971,0.0381035,0.0413923,0.0451928};

    float Jet_Energy_360GeV_JERError[6] = {0.0376666,0.037776,0.0395641,0.038776,0.0447257,0.0550854};

    float Jet_Energy_500GeV_JERError[6] = {0.0402936,0.0402612,0.0423655,0.0435815,0.0477389,0.0534081};
