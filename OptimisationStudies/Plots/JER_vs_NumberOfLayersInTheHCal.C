{
    ...
    float Jet_Energy_91GeV_JER[8] = {4.15954,3.81898,3.82021,3.88233,3.68123,3.68144,3.6965,3.70923};

    float Jet_Energy_200GeV_JER[8] = {3.35045,3.13551,2.96886,2.89729,2.92353,2.90164,2.89581,2.85293};

    float Jet_Energy_360GeV_JER[8] = {3.38347,3.07476,2.96963,2.93226,2.87282,2.8942,2.92408,2.88876};

    float Jet_Energy_500GeV_JER[8] = {3.5954,3.33187,3.19261,3.15088,3.06618,2.9751,3.02383,2.91974};

    float Jet_Energy_91GeV_JERError[8] = {0.053455,0.0490784,0.0490942,0.0498925,0.0473081,0.0473109,0.0501223,0.0476679};

    float Jet_Energy_200GeV_JERError[8] = {0.0429439,0.0401889,0.0380529,0.0371356,0.037472,0.0371913,0.0371166,0.036567};

    float Jet_Energy_360GeV_JERError[8] = {0.0430955,0.0391634,0.0378243,0.0373483,0.0365912,0.0368636,0.0372442,0.0367943};

    float Jet_Energy_500GeV_JERError[8] = {0.0459403,0.0425731,0.0407937,0.0402604,0.0391782,0.0381957,0.038637,0.0373071};
