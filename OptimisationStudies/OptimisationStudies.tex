...
In this study the active and absorber layers in the HCal are held constant and the total number of these layers varied.  This means that the total thickness of the calorimeter changes, while the sampling of particle showers in the calorimeter does not.  It is expected that this study will determine the effects of leakage of energy out of the back of the calorimeter, with a larger number of layers giving a smaller effect from leakage.  This is an important feature of the calorimeter design as the cost of the HCal will scale with the number of readout channels and so minimising the number of layers, while maintaining high quality physics performance is critical.  For this study detector models were simulated with a HCal containing 36, 42, 48, 54 and 60 layers.  The nominal ILD detector contains 48 layers.
