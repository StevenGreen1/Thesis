...
//=========  (Wed May  3 15:22:32 2017) by ROOT version5.34/37
   ...
   gStyle->SetOptStat(0);
   CosThetaStarSynJets->Range(-0.2666667,-8309.989,1.066667,58169.92);
   ...
   Alpha5Change->SetBinContent(1,26828.91);
   Alpha5Change->SetBinContent(2,26779.04);
   Alpha5Change->SetBinContent(3,26814.01);
   Alpha5Change->SetBinContent(4,27045.31);
   Alpha5Change->SetBinContent(5,27833.11);
   Alpha5Change->SetBinContent(6,28395.63);
   Alpha5Change->SetBinContent(7,29219.97);
   Alpha5Change->SetBinContent(8,30433.2);
   Alpha5Change->SetBinContent(9,32076.11);
   Alpha5Change->SetBinContent(10,36563.95);
   Alpha5Change->SetMinimum(0);
   Alpha5Change->SetMaximum(54845.92);
   Alpha5Change->SetEntries(5678796);
   ...
   TH1D *Alpha4Change = new TH1D("Alpha4Change","CosThetaStarSynJets_Alpha4_0.0015_Alpha5_0.0",10,0,1);
   Alpha4Change->SetBinContent(1,26463.64);
   Alpha4Change->SetBinContent(2,26489.48);
   Alpha4Change->SetBinContent(3,26558.7);
   Alpha4Change->SetBinContent(4,26739.38);
   Alpha4Change->SetBinContent(5,27455.45);
   Alpha4Change->SetBinContent(6,28097.73);
   Alpha4Change->SetBinContent(7,28967.71);
   Alpha4Change->SetBinContent(8,30270.13);
   Alpha4Change->SetBinContent(9,31953);
   Alpha4Change->SetBinContent(10,36235.61);
   Alpha4Change->SetMinimum(0);
   Alpha4Change->SetMaximum(54845.92);
   Alpha4Change->SetEntries(5678796);
   ...
   Reference->SetBinContent(1,26083.34);
   Reference->SetBinContent(2,26128.16);
   Reference->SetBinContent(3,26192.72);
   Reference->SetBinContent(4,26437.03);
   Reference->SetBinContent(5,27021.59);
   Reference->SetBinContent(6,27759.5);
   Reference->SetBinContent(7,28704.1);
   Reference->SetBinContent(8,30087.01);
   Reference->SetBinContent(9,31786.45);
   Reference->SetBinContent(10,35799.75);
   Reference->SetMinimum(0);
   Reference->SetMaximum(54845.92);
   Reference->SetEntries(5678796);
