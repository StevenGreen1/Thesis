...
//=========  (Wed May  3 15:24:34 2017) by ROOT version5.34/37
   ...
   gStyle->SetOptStat(0);
   CosThetaStarSynBosons->Range(-0.2666667,-1224.954,1.066667,8574.676);
   ...
   Alpha5Change->SetBinContent(1,2987.159);
   Alpha5Change->SetBinContent(2,2944.839);
   Alpha5Change->SetBinContent(3,3017.874);
   Alpha5Change->SetBinContent(4,3183.886);
   Alpha5Change->SetBinContent(5,3252.883);
   Alpha5Change->SetBinContent(6,3507.231);
   Alpha5Change->SetBinContent(7,3766.659);
   Alpha5Change->SetBinContent(8,4271.786);
   Alpha5Change->SetBinContent(9,5092.65);
   Alpha5Change->SetBinContent(10,7349.722);
   Alpha5Change->SetBinContent(11,0.05409141);
   Alpha5Change->SetMinimum(0);
   Alpha5Change->SetMaximum(8084.694);
   ...
   TH1F *Alpha4Change = new TH1F("Alpha4Change","CosThetaStarSynBosons_Alpha4_0.015_Alpha5_0.0",10,0,1);
   Alpha4Change->SetBinContent(1,2857.492);
   Alpha4Change->SetBinContent(2,2840.624);
   Alpha4Change->SetBinContent(3,2908.316);
   Alpha4Change->SetBinContent(4,3029.281);
   Alpha4Change->SetBinContent(5,3155.881);
   Alpha4Change->SetBinContent(6,3380.57);
   Alpha4Change->SetBinContent(7,3686.647);
   Alpha4Change->SetBinContent(8,4158.412);
   Alpha4Change->SetBinContent(9,5007.095);
   Alpha4Change->SetBinContent(10,7217.454);
   Alpha4Change->SetBinContent(11,0.05521495);
   Alpha4Change->SetMinimum(0);
   Alpha4Change->SetMaximum(8084.694);
   ...
   Reference->SetBinContent(1,2740.506);
   Reference->SetBinContent(2,2746.69);
   Reference->SetBinContent(3,2817.848);
   Reference->SetBinContent(4,2911.655);
   Reference->SetBinContent(5,3055.758);
   Reference->SetBinContent(6,3266.978);
   Reference->SetBinContent(7,3556.807);
   Reference->SetBinContent(8,4030.042);
   Reference->SetBinContent(9,4870.31);
   Reference->SetBinContent(10,7053.134);
   Reference->SetBinContent(11,0.05497033);
   Reference->SetMinimum(0);
   Reference->SetMaximum(8084.694);
