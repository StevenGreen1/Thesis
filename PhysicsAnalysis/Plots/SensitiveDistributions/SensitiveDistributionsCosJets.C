void SensitiveDistributionsCosJets()
{
    TString energy("1400");
...
//    TString upperLimit("0.02");
    ...
    TH2F *pTH2F_0_0 = (TH2F*)pTFile->Get(name + "_Alpha4_" + zeroFloat + "_Alpha5_" + zeroFloat);
    TH1D *pTH1F_0_0 = pTH2F_0_0->ProjectionX();
    pTH1F_0_0->Add(pTH2F_0_0->ProjectionY());

    TH2F *pTH2F_0p02_0 = (TH2F*)pTFile->Get(name + "_Alpha4_" + upperLimit + "_Alpha5_" + zeroFloat);
    TH1D *pTH1F_0p02_0 = pTH2F_0p02_0->ProjectionX();
    pTH1F_0p02_0->Add(pTH2F_0p02_0->ProjectionY());

    TH2F *pTH2F_0_0p02 = (TH2F*)pTFile->Get(name + "_Alpha4_" + zeroFloat + "_Alpha5_" + upperLimit);
    TH1D *pTH1F_0_0p02 = pTH2F_0_0p02->ProjectionX();
    pTH1F_0_0p02->Add(pTH2F_0_0p02->ProjectionY());
    ...
    pTH1F_0_0p02->GetXaxis()->SetTitle("Cos(#theta^{*}_{Jets})");
    pTH1F_0_0p02->GetXaxis()->SetTitleSize(0.05);
    pTH1F_0_0p02->GetXaxis()->SetLabelSize(0.05);
    pTH1F_0_0p02->GetYaxis()->SetTitle("Entries");
