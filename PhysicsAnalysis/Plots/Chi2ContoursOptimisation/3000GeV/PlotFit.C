...
//    pTCanvas->SaveAs(plotDotC);
    ...
    TF1 *pTF1a4 = new TF1("Alpha4Fit","[0]*x +[1]*x*x + [2]*x*x*x + [3]*x*x*x*x",-0.0008,0.0008);
//    TF1 *pTF1a4 = new TF1("Alpha4Fit","pol4",-0.0008,0.0008);
    pTGraph_a4->Fit("Alpha4Fit","MR","",-0.0008,0.0008);
    ...
    TF1 *pTF1a5 = new TF1("Alpha5Fit","[0]*x +[1]*x*x + [2]*x*x*x + [3]*x*x*x*x",-0.0008,0.0008);
//    TF1 *pTF1a5 = new TF1("Alpha5Fit","pol4",-0.0008,0.0008);
    pTGraph_a5->Fit("Alpha5Fit","MR","",-0.0008,0.0008);
