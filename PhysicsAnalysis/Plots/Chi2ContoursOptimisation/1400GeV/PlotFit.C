...
void PlotFit()
{
    ...
    TString name8 = "LPFOs_kt_0p90_1400GeV_FitData.root";
    TString name9 = "LPFOs_kt_1p10_1400GeV_FitData.root";
...
void MakePlots(TString name, TString description, TString briefDescription)
{
    ...
    TF1 *pTF1a4 = new TF1("Alpha4Fit","[0]*x +[1]*x*x + [2]*x*x*x + [3]*x*x*x*x",-0.005,0.005);
    pTGraph_a4->Fit("Alpha4Fit","MR","",-0.005,0.005);
    ...
    TF1 *pTF1a5 = new TF1("Alpha5Fit","[0]*x +[1]*x*x + [2]*x*x*x + [3]*x*x*x*x",-0.005,0.005);
    pTGraph_a5->Fit("Alpha5Fit","MR","",-0.005,0.005);
