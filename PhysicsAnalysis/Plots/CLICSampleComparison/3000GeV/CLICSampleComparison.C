...
{
    TString name1 = "/r06/lc/sg568/PhysicsAnalysis/MarlinJobs/Detector_Model_clic_ild_cdr/Reconstruction_Variant_clic_ild_cdr_ggHadBkg/ee_nunuqqqq/3000GeV/AnalysisTag18/SPFOs_kt_0p90/DetModel_clic_ild_cdr_RecoVar_clic_ild_cdr_ggHadBkg_ee_nunuqqqq_3000GeV_GenN_*_Tag18SPFOs_kt_0p90.root";
    TString name2 = "/r06/lc/sg568/PhysicsAnalysis/MarlinJobs/Detector_Model_clic_ild_cdr/Reconstruction_Variant_clic_ild_cdr_ggHadBkg/CLIC_ee_nunuqqqq/3000GeV/AnalysisTag18/SPFOs_kt_0p90/ProdID_6751_ee_nunuqqqq_3000GeV_Tag18_*SPFOs_kt_0p90.root";
...
TH1F *GetPlot(TString name, TString variable)
{
    ...
    double weight(71.5 * 2000 / nEventsToProcess);

//    TH1F *pTH1F = new TH1F(variable, variable, 140, 0, 1400); Visible Mass 1.4 TeV
    TH1F *pTH1F = new TH1F(variable, variable, 300, 0, 3000);// Visible Mass 3 TeV
