...
void FinalPlot()
{
    ...
    TString name1 = "TPFOs_kt_1p10_3000GeV_FitDataOptimal.root";
//    TString name2 = "SPFOs_kt_0p90_Final_1400GeV_FitData_Broken.root";
...
//    TGraph2D *pTGraph2D_b = SinglePlot(name2,"Chi2CosThetaStarSynJets");
    ...
    pTGraph2D->SetTitle("Longitudinally Invariant Kt, Tight Selected PFOs, R = 1.1");
    pTGraph2D->SetLineWidth(3);
//    pTGraph2D->Draw("CONT1");
    pTGraph2D->Draw("CONT1");
    pTGraph2D->SetMaximum(50);
//    pTGraph2D_b->SetLineStyle(2);
//    pTGraph2D_b->Draw("CONT1 same");
//    pTGraph2D_b->Draw("P same");
