...
void PlotDecomposition2()
{
    ...
    MakePlots(name, "Longitudinally Invariant Kt, Tight PFOs, R = 1.1", "CosThetaStarBosons", "Chi2CosThetaStarSynBosons");
    MakePlots(name, "Longitudinally Invariant Kt, Tight PFOs, R = 1.1", "CosThetaStarJets", "Chi2CosThetaStarSynJets");
    MakePlots(name, "Longitudinally Invariant Kt, Tight PFOs, R = 1.1", "MVV", "Chi2MVV");
}
