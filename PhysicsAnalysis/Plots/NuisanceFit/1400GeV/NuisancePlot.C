...
//    TString name2 = "SPFOs_kt_0p90_Sigma_egamma_qqqqnu_BS_0p01_Sigma_gammae_qqqqnu_BS_0p01_1400GeV_NuisanceFitData.root";
    TString name3 = "SPFOs_kt_0p90_Sigma_egamma_qqqqnu_BS_0p5_Sigma_gammae_qqqqnu_BS_0p5_1400GeV_NuisanceFitData.root";
...
//    Double_t levels[] = {0.0, 2.28, 4.61, 9.21, 1.79e308};
    ...
    pTGraph2D->GetXaxis()->SetRangeUser(-0.025,0.025);
    ...
    pTGraph2D->GetYaxis()->SetRangeUser(-0.025,0.025);
