...
void SignalBackgroundPlot()
{
    ...
    pTCanvas->cd();
    pTCanvas->SetRightMargin(0.1);
    pTCanvas->SetLeftMargin(0.175);
    pTCanvas->SetTopMargin(0.1);
    pTCanvas->SetBottomMargin(0.15);

    TString name0 = "TPFOs_kt_1p10_10Bins_All_3000GeV_Final_BuildIndividualDistributionData.root";
    ...
    Double_t edges[NBINS + 1] = {0.0, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 2900, 3000};
