...
A classic example of this is the Fermi theory for beta decay whereby the weak interaction occurring when a neutron decays into a proton, electron and anto-neutrino can be, at energies much below the mass of the mediating W boson, can be treated as a four-point vetex with quartic coupling strength $\text{G}_{F}$, the Fermi Coupling constant.  (Feynamn Diagram if keep)
