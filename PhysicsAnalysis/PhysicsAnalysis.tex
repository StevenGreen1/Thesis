...
The next step in the analysis chain was to calculate a number of event-based variables that are useful for the downstream analysis.  These variables can be divided into three categories:
\begin{itemize}
\item \texfbf{Particle level}.  This includes all variables related to the individual PFOs and includes:
\item \texfbf{Candidate boson}.  
\item \texfbf{Event based}.  
\end{itemize}
