...
The trends observed for single particles propagate into the jet energy resolution also, which can be see in figure \ref{ig:jertimingcuts}.  Continue from HERE.
