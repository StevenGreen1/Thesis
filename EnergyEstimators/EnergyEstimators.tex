...
The first technique to be examined is a truncation of the hadronic energy recorded in any given HCal hit, which improves the energy estimators for hadronic clusters by limiting the impact of Landau fluctuations.  In terms of $\omega$ introduced in equation \ref{equ:compensation} the truncation corresponds to:

\begin{equation}
\begin{aligned}
\omega(\rho) & = 1 \\
& = \frac{\Lambda}{V \times \rho}
\end{aligned}
\end{equation}
...
\begin{equation}
\omega(E_{\text{Raw}}, \rho) = p_{1}(E_{\text{Raw}}) \times exp(p_{2}(E_{\text{Raw}}) \times \rho) + p_{3}(E_{\text{Raw}}) \text{ ,}\\
p_{1} = p_{11} + p_{12} \times E_{\text{Raw}} + p_{13} \times E_{\text{Raw}}^{2} \text{ ,}\\
p_{2} = p_{21} + p_{22} \times E_{\text{Raw}} + p_{23} \times E_{\text{Raw}}^{2} \text{ ,}\\
