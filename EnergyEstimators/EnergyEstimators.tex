...
In a similar manor to as was done for the digitisation of the ECal the distribution, this time, of PFO energies is created with these selection cuts and a Gaussian fitted.  The mean of this fitted distribution, $E_{\text{Fit}}$, is extracted and $\beta^{EM}_{ECal}$ modified.


are calibrated in the simulation through carefully tuning of four constants in PandoraPFA.  These constants, the ECal/HCal response to electromagnetic/hadronic energy measurements, are set by considering the PFO energies of $\gamma$ and $K^{0}_{L}$ in much the same way as was done for the calibration of the digitisation.
