{
    ...
    pTGraphErrors_Variable_Default->SetLineColor(1);
    pTGraphErrors_Variable_Default->SetMarkerColor(1);
    pTGraphErrors_Variable_Default->SetMarkerStyle(1);
    pTGraphErrors_Variable_Default->Draw("lp,same");

    pLegend->AddEntry(pTGraphErrors_Variable_Default, "Standard Reconstruction", "lp");
    ...
    pTGraphErrors_Variable_Default_NoECorr->SetLineColor(kRed);
    pTGraphErrors_Variable_Default_NoECorr->SetMarkerColor(kRed);
    pTGraphErrors_Variable_Default_NoECorr->SetMarkerStyle(1);
    pTGraphErrors_Variable_Default_NoECorr->Draw("lp,same");

    pLegend->AddEntry(pTGraphErrors_Variable_Default_NoECorr, "No Basic Energy Corrections", "lp");
    ...
    pLegend->AddEntry(pTGraphErrors_Variable_Default_CellTruncation, "Optimal Cell Truncation", "lp");
    ...
    pLegend->Draw("same");
    pCanvasEj->SaveAs("JER_vs_JetEnergy_SoftwareCompensation.pdf");
}
