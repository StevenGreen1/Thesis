...
void DrawParams()
{
    ...
    pTF1_p1->GetXaxis()->SetTitleSize(0.076);
    pTF1_p1->GetXaxis()->SetLabelSize(0.076);
    ...
    pTF1_p2->GetXaxis()->SetTitleSize(0.076);
    pTF1_p2->GetXaxis()->SetLabelSize(0.076);
    pTF1_p2->GetYaxis()->SetTitle("#it{p}_{2}");
    pTF1_p2->GetYaxis()->SetTitleSize(0.076);
    pTF1_p2->GetYaxis()->SetLabelSize(0.076);
    ...
    pTF1_p3->GetXaxis()->SetTitleSize(0.076);
    pTF1_p3->GetXaxis()->SetLabelSize(0.076);
    pTF1_p3->GetYaxis()->SetTitle("#it{p}_{3}");
    pTF1_p3->GetYaxis()->SetTitleSize(0.076);
    pTF1_p3->GetYaxis()->SetLabelSize(0.076);

    TCanvas *pTCanvas_p1 = new TCanvas("c1","");
    pTCanvas_p1->SetBottomMargin(0.2);
    pTCanvas_p1->SetLeftMargin(0.15);
    pTCanvas_p1->Draw();
    pTF1_p1->Draw();
    ...
    pTCanvas_p2->SetBottomMargin(0.2);
    pTCanvas_p2->SetLeftMargin(0.15);
    pTCanvas_p2->Draw();
    pTF1_p2->Draw();
    ...
    pTCanvas_p3->SetBottomMargin(0.2);
    pTCanvas_p3->SetLeftMargin(0.15);
    pTCanvas_p3->Draw();
    pTF1_p3->Draw();
