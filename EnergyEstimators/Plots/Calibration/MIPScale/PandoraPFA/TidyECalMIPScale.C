...
{
    gROOT->ProcessLine(".x GeVToMIP_Calibration_10_GeV_Muons_ECal.C");
    TH1F *pTH1F = ECalDirectionCorrectedCaloHitEnergy;
    ...
    pTH1F->GetXaxis()->SetRangeUser(0.0,0.02);
    ...
    pTCanvas->Update();
    DrawVerticalLine(0.0065);

    pTCanvas->SaveAs("MIPScalePandoraPFAECal.pdf");
    pTCanvas->SaveAs("MIPScalePandoraPFAECal.C");
