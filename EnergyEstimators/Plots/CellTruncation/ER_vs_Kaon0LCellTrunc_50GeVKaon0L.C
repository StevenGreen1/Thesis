...
//=========  (Tue Mar 14 13:32:03 2017) by ROOT version5.34/30
   ...
   TH2F *axesEj = new TH2F("axesEj","",1,0,12,1000,6,12);
   axesEj->SetStats(0);
   axesEj->SetLineWidth(2);
   axesEj->SetMarkerStyle(20);
   axesEj->GetXaxis()->SetTitle("HCal Hit Energy Truncation [GeV]");
   ...
   gre->SetFillColor(1);
   gre->SetLineWidth(2);
   gre->SetPoint(0,0.5,9.105538);
   gre->SetPointError(0,0,0.2334118);
   gre->SetPoint(1,1,8.807201);
   gre->SetPointError(1,0,0.2497936);
   gre->SetPoint(2,2,8.851679);
   gre->SetPointError(2,0,0.2600611);
   gre->SetPoint(3,5,10.01026);
   gre->SetPointError(3,0,0.2796411);
   gre->SetPoint(4,10,10.35532);
   ...
   tLatex.DrawLatexNDC(0.25,0.8,"50 GeV K^{0}_{L}");

   c1->SaveAs("ER_vs_Kaon0LCellTrunc_50GeVKaon0L.pdf");
}
